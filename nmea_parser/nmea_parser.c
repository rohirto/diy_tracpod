...
//ESP IDF Defines hard coded values
...
#define CONFIG_NMEA_STATEMENT_GGA	ON
#define CONFIG_NMEA_STATEMENT_GSA	ON
#define CONFIG_NMEA_STATEMENT_GSV 	ON
#define CONFIG_NMEA_STATEMENT_RMC	ON
#define CONFIG_NMEA_STATEMENT_GLL	ON
#define CONFIG_NMEA_STATEMENT_VTG	ON
